...
const STORY_NODES = {
  ...
  m1: {
    ...
    situation:
      "Bulan ini tingkat salah sortir (defect rate) naik jadi 12% (sekitar 1.800 paket nyasar). Manajer Gudang sangat marah dan menyuruh Anda mengadakan 'Training Ketelitian' wajib di hari Minggu. Tapi setelah Anda observasi, ternyata 60% karyawan shift malam kurang tidur karena sistem rotasi jadwal 72-jam/minggu yang sangat berantakan.",
    options: [
      {
        ...
        feedback:
          'Evaluasi: Training berjalan, tapi karyawan yang sudah kurang tidur makin kesal karena hari liburnya hangus. Kesalahan sortir turun 3% sesaat, tapi diam-diam mereka mulai membenci tim HR.',
        nextNode: 'm2_hostile',
      },
      {
        ...
        feedback:
          'Evaluasi: Manajer sempat marah, tapi jadwal shift akhirnya dipangkas jadi 48-jam/minggu. Produktivitas sempat melambat 5% di awal penyesuaian, tapi karyawan sangat berterima kasih pada HR.',
        nextNode: 'm2_collab',
      },
    ],
  },
  m2_hostile: {
    ...
    limit: 2,
    situation:
      "Karena dipaksa ikut training bulan lalu, karyawan masih kesal. Ketika perusahaan merilis aplikasi absen baru senilai Rp 500 Juta, tingkat penggunaan (adoption rate) mandek di angka 35%. 65% sisanya sengaja tidak mau pakai dengan alasan 'ribet'. Pilih 2 tindakan:",
    options: [
      {
        id: 'a',
        text: 'Kasih Surat Peringatan (SP) masal bagi 65% staf yang menolak pakai aplikasi.',
        cult: -20,
        ops: 25,
        trust: -25,
      },
      {
        id: 'b',
        text: 'Tunda aplikasi 1 minggu, kumpulkan keluhan mereka agar aplikasinya dibuat lebih mudah.',
        cult: 10,
        ops: -15,
        trust: 15,
      },
      {
        id: 'c',
        text: 'Minta Manajer Area untuk sidak lapangan tiap pagi selama 14 hari berturut-turut.',
        cult: -15,
        ops: 15,
        trust: -15,
      },
      {
        id: 'd',
        text: 'Buka kotak saran anonim untuk memetakan spesifik 3 masalah utama aplikasinya.',
        cult: 15,
        ops: -5,
        trust: 10,
      },
  ...
  m2_collab: {
    ...
    limit: 2,
    situation:
      'Karyawan sudah cukup percaya pada Anda. Saat aplikasi kerja baru dirilis, tidak ada penolakan. Masalahnya, 40% staf senior (usia 45+ tahun) kebingungan cara pakainya, membuat proses input data melambat 20 menit tiap harinya. Pilih 2 inisiatif:',
    options: [
      {
        id: 'a',
        text: "Program 1-on-1: Anak muda (Gen Z) ditunjuk jadi 'Buddy' harian untuk staf senior.",
        cult: 15,
        ops: 5,
        trust: 15,
      },
      {
        id: 'b',
        text: 'Beri insentif top-up saldo e-wallet Rp 50.000/minggu untuk 10 pengguna tercepat.',
        cult: 10,
        ops: 15,
        trust: 10,
      },
      {
        id: 'c',
        text: 'Paksa mereka ikut ujian baca buku panduan 100 halaman dengan batas nilai 80.',
        cult: -10,
        ops: -5,
        trust: -10,
      },
      {
        id: 'd',
        text: 'Terapkan aturan potong gaji Rp 10.000 per 1 data yang salah masuk.',
        cult: -20,
        ops: 20,
        trust: -20,
      },
  ...
  m3_silo: {
    ...
    situation:
      "Demi kejar target penjualan Rp 5 Miliar, tim Sales menjanjikan 'Barang sampai besok!'. Padahal kapasitas Gudang sudah over-load 120%. Akibatnya, penalti klien tembus Rp 60 Juta bulan ini karena telat. Mereka saling menyalahkan. Anda punya Anggaran L&D Rp 100 Juta (100%). Atur persentasenya:",
    sliders: [
      {
        id: 's1',
        label:
          'Tukar Nasib (Sales wajib kerja 2 hari di gudang biar tahu nyatanya)',
        key: 'cult',
        color: 'bg-emerald-500',
      },
      {
        id: 's2',
        label: 'Bikin aturan denda ketat Rp 1 Juta/kejadian jika janji meleset',
        key: 'ops',
        color: 'bg-orange-500',
      },
      {
        id: 's3',
        label:
          'Sewa Vila untuk Liburan (Outing) 3 hari 2 malam agar mereka akrab',
        key: 'trust',
        color: 'bg-blue-500',
      },
    ],
  ...
  m4_burnout: {
    ...
    image:
      'https://images.unsplash.com/photo-1498551172505-8ee7ad69f235?auto=format&fit=crop&w=1000&q=80',
    icon: Link,
    context: 'Dampak Aturan Terlalu Ketat',
    situation:
      'Aturan denda ketat bulan lalu berhasil menurunkan kerugian penalti hingga 80%, tapi tingkat stres manajer naik drastis dan bertindak toxic. Pasangkan masalah 3 manajer ini dengan program L&D yang pas:',
    items: [
      {
        id: 'p1',
        label: 'Manajer Truk: Memaki sopir yang telat 15 menit kena macet.',
      },
      {
        id: 'p2',
        label:
          'Manajer Sales: Memanipulasi 5% data klien agar lolos dari denda.',
      },
      {
        id: 'p3',
        label: 'Supervisor Gudang: Kena serangan panik dan izin sakit 3 hari.',
      },
    ],
    answers: [
      {
        id: 'a1',
        label: 'Training Etika Kejujuran & Nilai Anti-Fraud Perusahaan',
      },
      {
        id: 'a2',
        label: 'Wajib Ambil Cuti 5 Hari & Difasilitasi Konseling Psikolog',
      },
      {
        id: 'a3',
        label: 'Sesi Coaching Cara Mengelola Emosi (Anger Management)',
      },
    ],
  ...
  m4_complacent: {
    ...
    situation:
      "Karena bulan lalu Anda kasih 50%+ dana untuk Outing, kepuasan karyawan (survey) naik ke angka 85%. TAPI produktivitas anjlok 15% karena mereka merasa 'kekeluargaan' dan segan menegur teman yang salah. Pasangkan solusinya:",
    items: [
      {
        id: 'p1',
        label:
          'Manajer Gudang: Mentolerir 20% stafnya yang telat masuk 30 menit.',
      },
      {
        id: 'p2',
        label:
          'Manajer Sales: Bersantai, 40% target jualan bulan ini gagal dicapai.',
      },
      {
        id: 'p3',
        label: 'Supervisor: Takut negur bawahan yang main HP saat jam kerja.',
      },
    ],
    answers: [
      {
        id: 'a1',
        label:
          'Latihan Cara Negur Tim dengan Tegas tapi Sopan (Komunikasi Asertif)',
      },
      {
        id: 'a2',
        label: 'Kalibrasi Ulang Target Harian & Coaching Performa Ketat',
      },
      {
        id: 'a3',
        label: 'Review Ulang SOP Jam Kerja & Terapkan Sanksi SP Bertahap',
      },
    ],
  ...
  m4_balanced: {
    ...
    situation:
      'Karena pembagian dana Anda seimbang, perusahaan stabil dengan target penjualan tercapai 95%. Ini saatnya Anda membantu 3 manajer menengah agar makin jago dan siap promosi. Pasangkan kelemahannya:',
    items: [
      {
        id: 'p1',
        label:
          'Manajer Armada: Jago teknis mesin 100%, tapi 0% paham arah bisnis perusahaan.',
      },
      {
        id: 'p2',
        label:
          'Manajer Sales: Bisa jualan Rp 2 Miliar/bulan sendirian, tapi kerjanya ditanggung sendiri (takut mendelegasikan).',
      },
      {
        id: 'p3',
        label:
          'Supervisor Senior: Kerjanya selalu rapi, tapi produktivitasnya mandek karena bosan 3 tahun jabatannya sama.',
      },
    ],
    answers: [
      {
        id: 'a1',
        label: 'Rotasi Kerja: Kasih tantangan proyek 2 bulan di divisi sebelah',
      },
      {
        id: 'a2',
        label:
          'Kelas Khusus Eksekutif: Belajar Strategi & Gambaran Besar Keuangan',
      },
      {
        id: 'a3',
        label:
          'Training Kepemimpinan: Seni Memberi Kepercayaan & Mendelegasikan Tugas',
      },
    ],
  ...
  m5_final: {
    ...
    image:
      'https://images.unsplash.com/photo-1556761175-5973dc0f32d7?auto=format&fit=crop&w=1000&q=80',
    icon: Award,
    context: 'Memilih Budaya Utama',
    situation:
      "Rapat terakhir Anda tahun ini dengan Direktur Utama. Dengan ancaman krisis ekonomi global yang diprediksi menurunkan profit industri sebesar 10% tahun depan, Beliau bertanya: 'Apa fokus nilai (core value) yang harus kita jalankan?'",
    options: [
      {
        ...
        feedback:
          'Hasil Akhir: Profit jangka pendek naik 12%. Namun, budaya kerja berubah menjadi sangat robotik dan tegang. Karyawan merasa hanya dihargai dari angkanya saja.',
        nextNode: 'ending',
      },
      {
        ...
        feedback:
          'Hasil Akhir: Profit tertahan di angka 5%. Tapi ternyata dengan tim yang akrab, biaya rekrutmen turun tajam karena tingkat turnover turun dari 25% menjadi hanya 8%!',
        nextNode: 'ending',
      },
    ],
  },
...
export default function CaseStudyApp() {
  ...
  const handleNextStep = () => {
    ...
    if (nextPendingNode === 'ending') {
      ...
      setTransitionMsg(
        `Waktu Berjalan... Memasuki Bulan Ke-${nextNodeData.month}`
      );
    }
  ...
  const submitMultiSelect = () => {
    ...
    applyImpact(
      { cult: dCult, ops: dOps, trust: dTrust },
      msg,
      currentStepData.evaluateNext()
    );
  };

  const submitAllocation = () => {
    const dCult =
      Math.floor((allocations.s1 - 33) * 0.5) +
      Math.floor((allocations.s3 - 33) * 0.2);
    const dOps =
      Math.floor((allocations.s2 - 33) * 0.6) +
      Math.floor((allocations.s1 - 33) * 0.2);
    const dTrust =
      Math.floor((allocations.s3 - 33) * 0.5) +
      Math.floor((allocations.s1 - 33) * 0.3) -
      Math.floor((allocations.s2 - 33) * 0.4);

    let msg = '';
    if (allocations.s2 > 50)
      msg =
        'Dampak: Denda ditekan hingga 0%, tapi orang jadi sibuk cari alasan biar nggak disalahkan. Kerjasama tim malah makin hancur karena takut denda.';
    else if (allocations.s3 > 50)
      msg =
        'Dampak: Kepuasan kerja menyentuh 90%. Tapi awas, mereka mulai santai, ngobrol terus, dan mengabaikan target pengiriman harian perusahaan.';
    else
      msg =
        'Dampak: Pengaturan anggaran yang mantap! Program tukar nasib 2 hari sukses bikin tim Sales sadar bahwa gudang sudah kepanasan dan overcapacity.';

    applyImpact(
      { cult: dCult, ops: dOps, trust: dTrust },
      msg,
      currentStepData.evaluateNext(allocations)
    );
  };
  ...
  const submitMatching = () => {
    ...
    const delta = {
      cult: correctCount * 10 - 10,
      ops: correctCount * 5 - 5,
      trust: correctCount * 10 - 10,
    };
    let msg = '';
    if (correctCount === 3)
      msg =
        'Akurasi 100%! Anda sangat jeli menggunakan data perilaku. Anda memberikan intervensi pengembangan yang tepat sasaran untuk metrik masing-masing manajer.';
    else if (correctCount > 0)
      msg =
        'Akurasi 33-66%. Ada beberapa yang benar. Tapi hati-hati, manajer yang dapat penugasan salah malah membuat performa divisinya turun 10%.';
    else
      msg =
        'Akurasi 0%! Memberikan intervensi yang tidak nyambung dengan masalah mereka membuat perusahaan rugi biaya training puluhan juta tanpa ada perubahan nyata.';
  ...
  const RadarChart = ({ data }) => {
    ...
    const getPos = (val, angleDeg) => {
      ...
      return `${center + r * Math.cos(angleRad)},${
        center + r * Math.sin(angleRad)
      }`;
    };

    const points = `${getPos(data.trust, 0)} ${getPos(data.cult, 120)} ${getPos(
      data.ops,
      240
    )}`;
    const fullPoints = `${getPos(100, 0)} ${getPos(100, 120)} ${getPos(
      100,
      240
    )}`;
      ...
      <div className="relative w-[180px] h-[180px] md:w-[200px] md:h-[200px] flex-shrink-0 animate-pulse-soft">
        ...
        >
          ...
          <line
            x1={center}
            y1={center}
            x2={center + radius * Math.cos((30 * Math.PI) / 180)}
            y2={center + radius * Math.sin((30 * Math.PI) / 180)}
            stroke="#cbd5e1"
          />
          <line
            x1={center}
        ...
        <div className="absolute -top-2 left-[50%] -translate-x-1/2 text-[9px] md:text-[10px] font-bold text-emerald-700 bg-emerald-50 px-1 rounded">
          KEPERCAYAAN
        </div>
        <div className="absolute bottom-2 -right-4 text-[9px] md:text-[10px] font-bold text-blue-700 bg-blue-50 px-1 rounded">
          BUDAYA
        </div>
        <div className="absolute bottom-2 -left-4 text-[9px] md:text-[10px] font-bold text-orange-700 bg-orange-50 px-1 rounded">
          OPERASIONAL
        </div>
      </div>
    );
  ...
  const getEnding = () => {
    ...
    if (cult > 70 && trust > 70 && ops > 60)
      return {
        title: 'Hero HR: Panutan Semua Orang',
        grade: 'A+',
        desc: 'Keren! Efisiensi gudang tembus 90% dan turnover turun ke 5%. Anda merubah perusahaan jadi tempat yang sangat produktif sekaligus nyaman. Bos Besar sangat puas!',
        color: 'text-emerald-700',
        bg: 'bg-emerald-50 border-emerald-200',
      };
    if (ops > 75 && trust < 45)
      return {
        title: 'Bos Galak: Target Hit, Team Quit',
        grade: 'C+',
        desc: 'Profit naik 15%, tapi turnover meroket ke angka 40%. Karyawan sangat tersiksa kerja dengan gaya polisi Anda. Perusahaan rugi besar untuk biaya rekrutmen ulang orang baru.',
        color: 'text-orange-700',
        bg: 'bg-orange-50 border-orange-200',
      };
    if (cult > 75 && ops < 45)
      return {
        title: 'Terlalu Baik: Gak Berani Tegas',
        grade: 'C',
        desc: 'Karyawan bahagia (Satisfaction Score 95%), tapi efisiensi gudang hancur lebur di bawah 50%. Perusahaan rugi ratusan juta karena Anda terlalu gak enakan pasang target ketat.',
        color: 'text-yellow-700',
        bg: 'bg-yellow-50 border-yellow-200',
      };
    if (avg < 45)
      return {
        title: 'Gagal Total: Minus di Semua Lini',
        grade: 'F',
        desc: 'Produktivitas turun 20% dan budaya kerja dipenuhi adu domba. Anda dipanggil Bos Besar dan diminta buat menyerahkan jabatan L&D Anda ke orang lain karena kapal nyaris tenggelam.',
        color: 'text-red-700',
        bg: 'bg-red-50 border-red-200',
      };
    return {
      title: 'HR Taktis: Penyelamat Standar',
      grade: 'B',
      desc: 'Angka operasional cukup stabil di kisaran 75% dan turnover ditahan di angka 15%. Belum memuaskan 100%, tapi kerja keras Anda meredam krisis patut diapresiasi oleh manajemen!',
      color: 'text-blue-700',
  ...
  const ProgressTimeline = () => {
    return (
      <div className="bg-blue-50 border-b border-blue-100 p-4 md:p-6 relative z-10 flex flex-col justify-center shadow-inner overflow-hidden">
        <div className="flex justify-between items-center relative w-full max-w-2xl mx-auto mt-2">
          {/* Connecting Line */}
          ...
          <div
            ...
            style={{
              width: `${
                (currentMonthNum > 0 ? currentMonthNum - 1 : 0) * 22.5
              }%`,
            }}
          ></div>
              ...
              >
                <div
                  className={`w-3 h-3 md:w-4 md:h-4 rounded-full border-2 transition-all duration-500 ${
                    isActive
                      ? 'bg-blue-600 border-white scale-150 shadow-md'
                      : isPast
                ...
                ></div>
                <span
                  className={`text-[8px] md:text-[10px] uppercase font-bold mt-2 md:mt-3 absolute top-3 md:top-4 whitespace-nowrap ${
          ...
          {/* The Moving Ship Icon */}
          <div
            className="absolute top-1/2 -translate-y-1/2 -mt-3 md:-mt-4 z-20 text-blue-900 transition-all duration-1000 ease-in-out drop-shadow-md animate-float-small"
            style={{
              left: `calc(5% + ${
                (currentMonthNum > 0 ? currentMonthNum - 1 : 0) * 22.5
              }% - 12px)`,
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-800 font-sans p-3 md:p-8 flex flex-col items-center overflow-x-hidden selection:bg-blue-200 relative">
      ...
      <div className="relative z-10 w-full max-w-6xl flex flex-col md:flex-row gap-5 md:gap-6">
        ...
        {/* On mobile: order-last (bottom), On desktop: order-first (left) */}
        <div className="w-full md:w-1/3 flex flex-col gap-5 md:gap-6 order-last md:order-first">
          ...
          <div className="hidden md:block bg-blue-950 p-6 rounded-3xl shadow-xl border border-blue-900 text-white relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
            ...
            <p className="text-xs text-blue-200 relative z-10 font-medium">
              Mini Game: Uji Keputusan HR Anda
            </p>
          </div>
          ...
          {currentNodeId !== 'intro' && currentNodeId !== 'ending' && (
            <div className="bg-white p-5 md:p-6 rounded-3xl shadow-lg border border-slate-200 flex flex-col items-center relative overflow-hidden">
              <h3 className="text-xs md:text-sm font-bold text-slate-500 uppercase tracking-widest mb-2 md:mb-4">
                Grafik Kinerja Anda
              </h3>
        ...
        {/* On mobile: order-first (top under header), On desktop: order-last (right) */}
        <div className="w-full md:w-2/3 order-first md:order-last">
          <div
            ref={gameBoardRef} // Ref for auto-scrolling
          ...
          >
            ...
            {/* Timeline */}
            {currentMonthNum > 0 && currentNodeId !== 'ending' && (
              <ProgressTimeline />
            )}
            ...
            {isTransitioning && (
              <div className="absolute inset-0 z-50 bg-blue-950 flex flex-col items-center justify-center overflow-hidden animate-fade-in rounded-b-3xl">
                ...
                <div className="animate-sail absolute top-1/2 -translate-y-1/2">
                  <Ship
                    size={60}
                    className="md:w-20 md:h-20 text-white drop-shadow-xl"
                    strokeWidth={1}
                    ...
                    <div className="w-full h-full bg-gradient-to-br from-blue-900 via-slate-800 to-blue-950 flex items-center justify-center animate-gradient-bg">
                      <div className="text-white/20 animate-pulse">
                        {currentStepData.icon && (
                          <currentStepData.icon size={80} strokeWidth={1} />
                        )}
                      </div>
                    </div>
                  )}
            ...
            <div className="px-5 md:px-10 pb-8 md:pb-10 flex-1 relative flex flex-col">
              ...
              {currentNodeId === 'intro' && !isTransitioning && (
                <div className="text-center flex-1 flex flex-col justify-center mt-[-30px] md:mt-[-80px] relative z-10">
                  ...
                  <h2
                    className="text-2xl md:text-5xl font-extrabold text-slate-900 mb-4 md:mb-6 leading-tight animate-slide-up"
                    style={{ animationDelay: '0.1s' }}
                  >
                    {currentStepData.title}
                  </h2>
                  <p
                    className="text-slate-600 text-base md:text-xl leading-relaxed mb-8 md:mb-10 max-w-2xl mx-auto animate-slide-up px-2"
              ...
              {currentNodeId === 'ending' && !isTransitioning && (
                <div className="animate-fade-in py-6 md:py-10 flex-1 flex flex-col justify-center">
                  <div className="animate-float mx-auto mb-4 md:mb-6">
                    <Award
                      size={64}
                      className={`md:w-20 md:h-20 ${getEnding().color}`}
                      strokeWidth={1.5}
                    />
                  </div>
                  <h2 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-6 md:mb-8 text-center">
                    Hasil Data Akhir Anda
                  </h2>

                  <div
                    className={`${
                      getEnding().bg
                    } p-6 md:p-12 rounded-3xl text-center mb-6 md:mb-8 shadow-sm border transform transition-all hover:scale-[1.02] duration-300`}
                  >
                    <div
                      className={`text-5xl md:text-8xl font-black mb-3 md:mb-4 drop-shadow-sm ${
                        getEnding().color
                      }`}
                    >
                      {getEnding().grade}
                  ...
                  <div className="flex justify-center mt-2 md:mt-4">
                    <button
                      ...
                      className="w-full md:w-auto flex items-center justify-center gap-3 px-6 md:px-8 py-4 bg-slate-800 hover:bg-slate-900 rounded-2xl transition-all shadow-lg text-white font-bold text-base md:text-lg active:scale-95"
                    >
                ...
                !isTransitioning && (
                  <div className="animate-fade-in mt-[-30px] md:mt-[-60px] relative z-10 flex-1 flex flex-col">
                    <div className="flex flex-col md:flex-row md:items-end gap-3 md:gap-5 mb-6 md:mb-8 pb-5 md:pb-6 border-b border-slate-200">
                      <div
                        className="p-3 md:p-4 bg-white shadow-xl border border-slate-100 text-blue-900 rounded-2xl animate-float self-start"
                      ...
                      <div className="pb-1 animate-slide-up mt-2 md:mt-0">
                        <span className="text-blue-700 text-[10px] md:text-xs font-bold uppercase tracking-widest bg-blue-50 px-3 py-1 rounded-full border border-blue-100">
                          {currentStepData.context}
                        </span>
                        <h2 className="text-xl md:text-3xl font-extrabold text-slate-900 mt-2 md:mt-3 leading-snug">
                          {currentStepData.title}
                        </h2>
                      </div>
                    </div>
                    ...
                    <p
                      className="text-slate-700 text-base md:text-xl leading-relaxed mb-8 md:mb-10 animate-slide-up"
                      style={{ animationDelay: '0.1s' }}
                    >
                      {currentStepData.situation}
                    </p>
                        ...
                        <div className="space-y-3 md:space-y-4">
                          {currentStepData.options.map((opt, idx) => (
                            ...
                            >
                              ...
                              <span className="text-slate-700 group-hover:text-blue-950 flex-1 font-medium text-sm md:text-lg leading-snug">
                                {opt.text}
                              </span>
                            </button>
                          ))}
                      ...
                      {currentStepData.type === 'multi_select' && (
                        <div>
                          <div className="flex flex-wrap md:flex-nowrap justify-between items-center gap-2 mb-4 md:mb-6 bg-slate-50 p-3 md:p-4 rounded-xl border border-slate-200">
                            <span className="text-[11px] md:text-sm font-bold text-slate-600 uppercase tracking-wide">
                              Pilih {currentStepData.limit} Tindakan:
                            </span>
                            <span
                              className={`text-[11px] md:text-sm font-bold px-3 py-1 md:py-1.5 rounded-full transition-colors duration-300 ${
                                multiSelect.length === currentStepData.limit
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4 mb-6 md:mb-8">
                            {currentStepData.options.map((opt) => {
                              ...
                              return (
                                ...
                                >
                                  <div
                                    className={`mt-0.5 rounded-full p-1 border-2 flex-shrink-0 transition-all duration-300 ${
                                      isSelected
                                        ? 'border-blue-900 text-blue-900 bg-white rotate-12'
                      ...
                      {currentStepData.type === 'allocation' && (
                        <div>
                          <div className="mb-6 md:mb-8 p-4 md:p-6 bg-slate-50 rounded-2xl border border-slate-200 shadow-inner">
                            <h4 className="text-center text-[10px] md:text-sm font-bold text-slate-500 uppercase tracking-widest mb-3 md:mb-4">
                              Grafik 100% Anggaran
                            </h4>
                            <div className="h-6 md:h-8 w-full bg-slate-200 rounded-full overflow-hidden flex shadow-inner">
                              <div
                                style={{ width: `${allocations.s1}%` }}
                                className="bg-emerald-500 h-full transition-all duration-500 flex items-center justify-center text-[10px] md:text-xs font-bold text-white"
                              >
                                {allocations.s1 > 10
                                  ? `${allocations.s1}%`
                                  : ''}
                              ...
                              <div
                                style={{ width: `${allocations.s2}%` }}
                                className="bg-orange-500 h-full transition-all duration-500 flex items-center justify-center text-[10px] md:text-xs font-bold text-white"
                              >
                                {allocations.s2 > 10
                                  ? `${allocations.s2}%`
                                  : ''}
                              ...
                              <div
                                style={{ width: `${allocations.s3}%` }}
                                className="bg-blue-500 h-full transition-all duration-500 flex items-center justify-center text-[10px] md:text-xs font-bold text-white"
                              >
                                {allocations.s3 > 10
                                  ? `${allocations.s3}%`
                                  : ''}
                              ...
                              >
                                <div className="flex justify-between mb-3 md:mb-4 items-start md:items-center">
                                  <span className="text-xs md:text-base font-bold text-slate-700 pr-2 flex items-start md:items-center gap-2 leading-tight">
                                    <span
                                      className={`w-2 h-2 md:w-3 md:h-3 rounded-full mt-1 md:mt-0 flex-shrink-0 ${slider.color}`}
                                    ></span>
                                    {slider.label}
                                  </span>
                                  <span className="text-blue-900 font-mono font-extrabold bg-blue-50 px-2 py-1 md:px-3 md:py-1.5 rounded-lg border border-blue-100 flex-shrink-0 text-sm md:text-lg">
                                    {allocations[slider.id]}%
                                  </span>
                                </div>
                                <input
                                  type="range"
                        ...
                        <div>
                          <div className="space-y-4 md:space-y-6 mb-6 md:mb-8">
                            {currentStepData.items.map((item) => (
                              <div
                                key={item.id}
                                className="bg-white p-4 md:p-5 rounded-2xl border border-slate-200 shadow-sm"
                              >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-2 md:gap-3">
                                  {currentStepData.answers.map((ans) => {
                                    const isSelectedHere =
                                      matches[item.id] === ans.id;
                                    const isSelectedElsewhere =
                                      Object.values(matches).includes(ans.id) &&
                                      !isSelectedHere;
                                    ...
                                    return (
                                      <button
                                        key={ans.id}
                                        onClick={() =>
                                          handleMatchSelect(item.id, ans.id)
                                        }
              ...
              {showFeedback && !isTransitioning && (
                <div className="absolute inset-0 z-20 bg-white/95 backdrop-blur-md p-5 md:p-10 flex flex-col justify-start md:justify-center items-center text-center animate-fade-in border-t-4 md:border-t-8 border-blue-950 rounded-b-3xl overflow-y-auto">
                  ...
                  <h3 className="text-2xl md:text-3xl font-extrabold text-slate-900 mb-4 md:mb-6">
                    Evaluasi Kinerja
                  </h3>
                  ...
                  <div className="flex flex-wrap justify-center gap-3 md:gap-4 mb-8 md:mb-12 w-full">
                    <StatPill
                      label="Trust"
                      delta={impactDelta.trust}
                      color="text-emerald-700"
                      bg="bg-emerald-50"
                    />
                    <StatPill
                      label="Culture"
                      delta={impactDelta.cult}
                      color="text-blue-700"
                      bg="bg-blue-50"
                    />
                    <StatPill
                      label="Ops"
                      delta={impactDelta.ops}
                      color="text-orange-700"
                      bg="bg-orange-50"
                    />
                  </div>
...
const MetricBar = ({ label, value, color, text, bg, border }) => (
  <div
    className={`flex flex-col gap-1 p-2 md:p-3 rounded-xl border ${bg} ${border}`}
  >
...
const StatPill = ({ label, delta, color, bg }) => {
  ...
  return (
    <div
      className={`px-4 py-3 md:px-6 md:py-4 flex-1 md:flex-none min-w-[80px] rounded-xl md:rounded-2xl font-bold border-2 flex flex-col md:flex-row items-center md:gap-3 shadow-sm ${
        isPos
          ? `${bg} border-slate-200 text-slate-800`
          : 'bg-red-50 border-red-200 text-red-800'
      }`}
    >
      <span className="text-[9px] md:text-sm uppercase tracking-widest text-slate-500 mb-1 md:mb-0">
        {label}
      </span>
      <span
        className={`text-xl md:text-3xl leading-none ${
          isPos ? color : 'text-red-600'
        }`}
      >
        {isPos ? '+' : ''}
        {delta}
